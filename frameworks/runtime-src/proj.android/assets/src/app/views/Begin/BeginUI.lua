...
--Create Cocos Studio UI
    local function createCocosStudioUI()
        ...
        scrollView:setInnerContainerSize({width = 767, height = 192})
        ...
        layout:setSize({width = 767.9999, height = 128.0000})
        ...
        layout:setSize({width = 767.9999, height = 192.0000})
        ...
        layout:setSize({width = 767.9999, height = 448.0000})
        layout:setLeftMargin(96.0000)
        layout:setRightMargin(96.0000)
        ...
        layout:setSize({width = 767.9999, height = 544.0000})
        layout:setLeftMargin(96.0000)
        layout:setRightMargin(96.0000)
        layout:setTopMargin(96.0000)
        ...
        divineLifeItem:setTitleFontName("fonts/STHUPO.TTF")
        ...
        divineEnterpriseItem:setTitleFontName("fonts/STHUPO.TTF")
        ...
        divineLoveItem:setTitleFontName("fonts/STHUPO.TTF")
