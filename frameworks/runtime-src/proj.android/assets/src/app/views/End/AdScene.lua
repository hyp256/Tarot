...
--[[
    ...
    local label = cc.Label:createWithSystemFont("play placement 3", "sans", 28)
    local item = cc.MenuItemLabel:create(label)
    item:onClicked(function()
        print("play placement 3")
        sdkbox.PluginSdkboxAds:placement("placement-3")
    end)
    menu:addChild(item)
    ...
    menu:addChild(cc.MenuItemLabel:create(cc.Label:createWithSystemFont("AdMob load interstitial", "sans", 24)):onClicked(function()
        print("AdMob load interstitial")
        sdkbox.PluginAdMob:cache("gameover")
    end))

    menu:addChild(cc.MenuItemLabel:create(cc.Label:createWithSystemFont("AdMob show interstitial", "sans", 24)):onClicked(function()
        print("AdMob show interstitial")
