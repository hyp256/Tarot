...
--Create root
local Answer5UI = class("Answer5UI", cc.load("mvc").ViewBase, function()
    root = cc.Node:create()
    root:setName("uiRoot")
    return root
end)
...
--Create Cocos Studio UI
    local function createCocosStudioUI()
        ...
        label_Aside:setString(Aside_Answer["Aside_Answer5"])
        ...
        scrollView_Context:setInnerContainerSize({width = 815, height = 640})
        ...
        context_Aside:setFontName("fonts/simhei.ttf")
        context_Aside:setFontSize(24)
        ...
        context_Aside:setPosition(408.0000, 320.0000)
        ...
        layout:setPercentHeight(1.0000)
        layout:setSize({width = 611.9999, height = 640.0000})
        ...
        choiceEndItem:setTitleFontName("fonts/STHUPO.TTF")
        choiceEndItem:setTitleFontSize(36)
        choiceEndItem:setTitleText(Ui_Answer_Button["Ui_Answer5_Button_end"])
        ...
        closeContextAsideItem:setTitleFontName("fonts/STHUPO.TTF")
...
--构造函数,在create中执行
function Answer5UI:ctor()
        initUI()
end

function Answer5UI:getUIItem(args)
