...
--Create Cocos Studio UI
    local function createCocosStudioUI()
        ...
        --Create shareItem
        shareItem = ccui.Text:create()
        shareItem:ignoreContentAdaptWithSize(true)
        shareItem:setTextAreaSize({width = 0, height = 0})
        shareItem:setFontName("fonts/STHUPO.TTF")
        shareItem:setFontSize(48)
        shareItem:setString(Ui_End_Button["Ui_End_Button_Share"])
        shareItem:setTouchScaleChangeEnabled(true)
        shareItem:setTouchEnabled(true);
        ...
        shareItem:setPosition(61.4400, 43.5200)
        ...
        layout:setRightMargin(658.0600)
        layout:setTopMargin(475.4800)
        layout:setBottomMargin(18.5200)
