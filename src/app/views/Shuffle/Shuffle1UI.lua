...
--Create scrollView
        ...
        label_Aside:setPosition(383.5000, 0.0000)
        ...
        layout:setSize({width = 767.0000, height = 192.0000})
        ...
        shuffleTopItem:setTitleFontName("fonts/STHUPO.TTF")
        ...
        shuffleCenterItem:setTitleFontName("fonts/STHUPO.TTF")
        ...
        shuffleBottomItem:setTitleFontName("fonts/STHUPO.TTF")
        ...
        shuffleNextItem:setTitleFontName("fonts/STHUPO.TTF")
