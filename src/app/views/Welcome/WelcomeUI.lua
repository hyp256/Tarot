...
--Create Cocos Studio UI
    local function createCocosStudioUI()
        ...
        backGround:setBackGroundImage("Photos/TAROTWELCOMETIRANGLE.png",0)
        ...
        --Create backGroundCircle
        local backGroundCircle = ccui.Layout:create()
        backGroundCircle:ignoreContentAdaptWithSize(false)
        backGroundCircle:setBackGroundImage("Photos/TAROTWELCOMECIRCLE.png",0)
        backGroundCircle:setClippingEnabled(false)
        backGroundCircle:setBackGroundColorType(1)
        backGroundCircle:setBackGroundColor({r = 0, g = 0, b = 0})
        backGroundCircle:setBackGroundColorOpacity(0)
        backGroundCircle:setTouchEnabled(true);
        backGroundCircle:setLayoutComponentEnabled(true)
        backGroundCircle:setName("backGroundCircle")
        backGroundCircle:setTag(21)
        backGroundCircle:setCascadeColorEnabled(true)
        backGroundCircle:setCascadeOpacityEnabled(true)
        backGroundCircle:setAnchorPoint(0.5000, 0.5000)
        backGroundCircle:setPosition(480.0000, 320.0000)
        layout = ccui.LayoutComponent:bindLayoutComponent(backGroundCircle)
        layout:setPositionPercentXEnabled(true)
        layout:setPositionPercentYEnabled(true)
        layout:setPositionPercentX(0.5000)
        layout:setPositionPercentY(0.5000)
        ...
        layout:setLeftMargin(180.0000)
        layout:setRightMargin(180.0000)
        root:addChild(backGroundCircle)

        local addS = cc.TintTo:create(3.0,'255', '255', '255')
        local subS = cc.TintTo:create(4.0,'85', '85', '85')
        local Daley = cc.DelayTime:create(2.0)
        local Sequence = cc.Sequence:create(subS, addS, Daley)
        local Action = cc.RepeatForever:create(Sequence)
        backGroundCircle:runAction(Action)
        ...
        label_Aside:setFontName("fonts/junegull rg.ttf")
